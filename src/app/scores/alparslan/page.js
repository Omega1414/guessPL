...
export default function VasifResults() {
  ...
  useEffect(() => {
    const fetchScores = async () => {
      try {
        ...
        const scores = await calculateUserScores("GXGFuYcuyIfq8YvOORFOkBTMk6H3"); // Vasifin user ID-sini daxil et
  ...
  return (
    <div className="flex flex-col items-center p-6">
      ...
      <div className="gap-3 mt-6 grid grid-cols-1 xl:grid-cols-2 h-full items-center my-auto">
